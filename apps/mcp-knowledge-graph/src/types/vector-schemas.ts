...
export const EmbeddingSchema = z.array(z.number()).min(1, 'Embedding must have at least 1 dimension');
...
export const EmbeddingGenerationOptionsSchema = z.object({
  model: z.string().min(1).optional().default('simple'),
...
export const HybridSearchOptionsSchema = z.object({
  ...
  (data) => Math.abs(data.vectorWeight! + data.traditionalWeight! - 1.0) < 0.001,
  {
...
export const HybridSearchRequestSchema = z.object({
  ...
  properties: z.record(z.unknown()).optional(),
  ...HybridSearchOptionsSchema.shape,
}).strict();
...
export const SmartNodeMergeResultSchema = z.object({
  node: z.object({
    id: z.string().uuid(),
    type: z.string().min(1),
    label: z.string(),
...
export const SmartEdgeMergeOptionsSchema = z.object({
  mergeStrategy: MergeStrategySchema.optional().default('merge'),
  allowMultipleTypes: z.boolean().optional().default(false),
}).strict();

export const SmartEdgeMergeRequestSchema = z.object({
...
export const SmartEdgeMergeResultSchema = z.object({
  edge: z.object({
    id: z.string().uuid(),
    sourceId: z.string().uuid(),
    targetId: z.string().uuid(),
...
export const ContextualInfoOptionsSchema = z.object({
...
export const ContextualInfoRequestSchema = z.object({
...
export const ContextualInfoSummarySchema = z.object({
...
export const ContextualInfoResultSchema = z.object({
...
export const RichContextOptionsSchema = z.object({
...
export const RichContextRequestSchema = z.object({
...
export const RichNodeContextSchema = z.object({
...
export const NetworkSummarySchema = z.object({
  ...
  strongestConnections: z.array(z.object({
...
export const RichContextResultSchema = z.object({
...
export const SimilarityAnalysisRequestSchema = z.object({
...
export const SimilarityAnalysisResultSchema = z.object({
...
export function validateVectorSearchRequest(request: unknown): z.infer<typeof VectorSearchRequestSchema> {
  return VectorSearchRequestSchema.parse(request);
}

export function validateHybridSearchRequest(request: unknown): z.infer<typeof HybridSearchRequestSchema> {
  return HybridSearchRequestSchema.parse(request);
}

export function validateSmartMergeRequest(request: unknown): z.infer<typeof SmartNodeMergeRequestSchema> {
  return SmartNodeMergeRequestSchema.parse(request);
}

export function validateContextualInfoRequest(request: unknown): z.infer<typeof ContextualInfoRequestSchema> {
  return ContextualInfoRequestSchema.parse(request);
}

export function validateRichContextRequest(request: unknown): z.infer<typeof RichContextRequestSchema> {
  return RichContextRequestSchema.parse(request);
}

export function validateSimilarityAnalysisRequest(request: unknown): z.infer<typeof SimilarityAnalysisRequestSchema> {
